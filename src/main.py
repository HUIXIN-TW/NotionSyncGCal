...
def main():
    ...
    parser.add_argument('-t', '--timestamp', nargs=2, type=int, help="Update Notion Task and Google Calendar By timestamp")
    parser.add_argument('-g', '--google', nargs=2, type=int, help="Force: Update Notion Task From Google Calendar")
    parser.add_argument('-n', '--notion', nargs=2, type=int, help="Force: Update Google Calendar From Notion Task")
